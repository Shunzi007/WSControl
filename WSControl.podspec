#
#  Be sure to run `pod spec lint WSControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of WSControl in Markdown format.
  ...
  # s.social_media_url   = "http://twitter.com/王顺"
  ...
  s.source_files  = "WSControl", "WSControl/*.{h,m}"
  #s.exclude_files = "WSControl/*.{h,m}"
